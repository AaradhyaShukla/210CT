...
#such as .txt. The following tree operations should be implemented: a) Listing (word,
...
if __name__ == "__main__":
	bst = create_tree_from_file("words.txt")
	print("Tree listed in words.txt:\n ")
	bst.list()
	print("\nTree in preorder:\n")
	bst.preorder()
